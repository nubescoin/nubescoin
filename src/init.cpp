    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Nubescoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  nubescoind [options]                     " + "\n" +
                  "  nubescoind [options] <command> [params]  " + _("Send command to -server or nubescoind") + "\n" +
                  "  nubescoind [options] help                " + _("List commands") + "\n" +
                  "  nubescoind [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: nubescoind.pid)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Nubescoin Wiki for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Nubescoin is probably already running."), strDataDir.c_str()));
