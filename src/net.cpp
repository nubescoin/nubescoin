...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Nubescoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"nubescointools.com", "118.99.96.170"}, // public 118.99.96.170 server 159.203.112.221
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"nubescointools.com", "testnet-seed.nubescointools.com"},
